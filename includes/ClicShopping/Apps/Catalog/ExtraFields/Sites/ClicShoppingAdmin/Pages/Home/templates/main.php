...
<div class="contentBody">
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_ExtraFields->getDef('text_products_extra_fields'); ?></strong></div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <div class="col-md-12">
            <?php echo $CLICSHOPPING_ExtraFields->getDef('text_intro'); ?>
          </div>
        </div>
        <div class="separator"></div>
        ...
        <div class="col-md-12 text-center">
          <div class="form-group">
            <div class="col-md-12">
              <?php
                echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Catalog\ExtraFields&Configure'));
                echo HTML::button($CLICSHOPPING_ExtraFields->getDef('button_configure'), null, null, 'primary');
                echo '</form>';
              ?>
            </div>
          </div>
